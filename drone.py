...
class HexacopterStatus:
    """docstring for HexacopterStatus"""
...
class Hexacopter:
    ...
    def set_motor_speed(self, motor_speed):
        ...
        if motor_speed > self.__class__.MAX_SPEED:
            raise ValueError('The maximum seed is {0}'.format(self.__class__.MAX_SPEED))
        self.motor_speed = motor_speed
...
class LightEmittingDiode:
    """docstring for LightEmittingDiode."""
